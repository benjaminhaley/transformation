...
Notice that images in nature never look like static.  This is because they rotate, translate, scale, and otherwise distort in ways that are far from random.  Static images only emerge after random transformations, and so they frequently contain patterns that rarely occur in nature.
