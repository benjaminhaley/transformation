...
1. Not all transformations fit the commonly known transformations.  Even this simple inquiry uncovered many likely image transformations which are difficult to describe formally.  Likely images were stretched and bent in ways that are quite familiar to the eye, but well beyond the geometric transformations we learn in highschool.  We can only explicitly teach computers those things that we can describe, for the rest, computers, like us, must learn on their own.
